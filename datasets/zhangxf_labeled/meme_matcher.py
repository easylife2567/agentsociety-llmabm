...
STRONG = [
    ...
    "跑步猝死", "根巧", "格聂", "一根雪糕解决不了",
    # 变体展开（词表_玩梗型 §十 16 种模式；用户 2026-09-10 裁定恢复，变体词全收高召回，
    # ≤2字与拉丁缩写误伤风险已由用户接受。emoji 嵌字/空格分隔/叠字儿化变体
    # 由归一化层剥离或主词子串覆盖，不重复收录；zhangsheng 等谐音普通人名按 md 排除）
    # 巧乐兹：同音/形近/拼音/数字谐音/倒序/中间插字
    "巧勒兹", "巧乐滋", "桥乐兹", "巧乐子", "QLZ", "76兹", "兹乐巧", "巧了个乐兹", "巧le兹",
    # 雪碧：谐音/倒序/广告语截短/拼音
    "雪壁", "雪毕", "雪毙", "雪璧", "XB", "碧雪", "透心凉", "xue碧",
    # 跑步机：谐音/拼音首字母/误写
    "跑步鸡", "跑步基", "PBJ", "跑不机", "跑机", "跑台",
    # 牢峰/牢张/牢雪：形近/拼音/首字母
    "牢锋", "牢蜂", "laofeng", "LF",
    "牢章", "牢彰", "laozhang", "LZ",
    "牢学", "牢穴", "laoxue", "LX",
    # 张圣/念张师：繁体/首字母（张生张胜谐音人名排除）
    "张聖", "ZS",
    "念章师", "念張師", "NZS",
    # 语录变体/首字母缩写；赛博永生·社达谐音
    "你跑不过我你信嘛", "NPGMWNXM",
    "赛博永升", "赛博永牲", "SBYS", "射达",
]
