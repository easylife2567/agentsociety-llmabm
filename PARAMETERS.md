...
| marketing（营销 26 人） | 0.95 [0.5, 1.5] | 0.2 [0.0, 0.8] | **0.05** [0.0, 0.2] | ~~0~~ |
...
- **decay**：注意力疲劳——悼念情感疲劳最快；**营销 2026-09-12 由 0.1 降至 0.05**（用户裁定：营销几乎不存在疲劳衰减；代理扫描 0.01-0.1 后取效标最优档 —— 玩梗 W20-22 的 RMSE 0.037、W22 0.581 vs 真实 0.603）。
